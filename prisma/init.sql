...
-- CreateEnum
CREATE TYPE "OrderFileType" AS ENUM ('DOCUMENT', 'CONTRACT', 'PRODUCTION', 'INSTALLATION', 'OTHER', 'WORK_ORDER_GLASS', 'WORK_ORDER_PVC', 'WORK_ORDER_ALUMINUM', 'MATERIALS_LIST');
...
CREATE TABLE "clients" (
    ...
    "email" TEXT,
    "address" TEXT,
    "status" "ClientStatus" NOT NULL DEFAULT 'PRIVATE',
